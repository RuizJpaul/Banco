import { Movimiento } from "./clase.js";
...
document.addEventListener("DOMContentLoaded", () => {
  document.getElementById("btn1").addEventListener("click", registrar);
});


document.addEventListener("DOMContentLoaded", () => {
  document.getElementById("btn2").addEventListener("click", elegirProceso);
}); 